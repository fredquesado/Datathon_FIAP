...
def main():
    ...
    # Adicionar a imagem de fundo e aplicar transparência
    st.markdown(
        f"""
        <style>
        ...
        /* Estilo da caixa centralizada com leve transparência */
        .badge {{
            background-color: rgba(255, 255, 255, 0.85);  /* Transparência da caixa */
            padding: 30px;
            border-radius: 15px;
        ...
        h1 {{
            ...
            font-weight: 700;
            color: #2e4053;  /* Título azul-acinzentado */
            text-align: center;
        ...
        h2 {{
            font-family: 'Poppins', sans-serif;
            font-weight: 400;
            color: #1c2833;  /* Texto cinza escuro */
            text-align: center;
            font-size: 1.2em;
            margin-bottom: 50px;
            line-height: 1.5;
